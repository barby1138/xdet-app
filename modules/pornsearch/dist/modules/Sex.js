...
var Sex = function (_AbstractModule$with) {
  ...
  (0, _createClass3.default)(Sex, [{
    ...
    value: function videoUrl(page) {
      return 'http://www.sex.com/search/videos?query=' + encodeURI(this.query) + '&page=' + (page || this.firstpage);
    }
  }, {
    key: 'gifUrl',
    value: function gifUrl(page) {
      return 'http://www.sex.com/search/gifs?query=' + encodeURI(this.query) + '&page=' + (page || this.firstpage);
    }
  }, {
    key: 'videoParser',
